...
custom_result = mean(@benchmark(@optimize fib($35)))
...
custom_result = mean(@benchmark(@optimize matmul($1024)))
push!(normal, normal_result.time)
push!(custom, custom_result.time)
push!(normal_mem, normal_result.memory)
push!(custom_mem, custom_result.memory)
...
custom_result = mean(@benchmark(@optimize sortfunc($1000000)))
push!(normal, normal_result.time)
push!(custom, custom_result.time)
push!(normal_mem, normal_result.memory)
push!(custom_mem, custom_result.memory)
...
custom_result = mean(@benchmark(@optimize gcd($10000000, $9999999)))
push!(normal, normal_result.time)
push!(custom, custom_result.time)
push!(normal_mem, normal_result.memory)
push!(custom_mem, custom_result.memory)
...
for i in 1:50
    ...
    push!(ys_custom, mean(@benchmark(@optimize fib($i))).time)
